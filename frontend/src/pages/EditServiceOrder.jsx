          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                ...
                <Select value={formData.status || "ABERTO"} onValueChange={(value) => updateField("status", value)}>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <Select value={formData.verification_mode || "DIGITAL"} onValueChange={(value) => updateField("verification_mode", value)}>
            ...
            {(formData.verification_mode || "DIGITAL") === "DIGITAL" ? (
              <div className="space-y-4">
