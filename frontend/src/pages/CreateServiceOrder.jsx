    ...
    try {
      ...
      if (extracted && !extracted.parse_error) {
        setFormData(prev => ({
          ...
          equipment_type: extracted.equipment_type || prev.equipment_type,
          equipment_brand: extracted.equipment_brand || prev.equipment_brand,
          equipment_model: extracted.equipment_model || prev.equipment_model,
      ...
      <main className="container mx-auto px-6 py-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-semibold text-slate-800 mb-4">Upload de Imagem (OCR)</h2>
              ...
              <div>
                <Label htmlFor="image-upload" className="cursor-pointer">
                  <div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-blue-500 transition-colors">
                    {imagePreview ? (
                      <img src={imagePreview} alt="Preview" className="max-h-48 mx-auto mb-4 rounded-lg" />
                    ) : (
                      <ImageIcon className="w-16 h-16 text-slate-400 mx-auto mb-4" />
                    )}
                    <p className="text-sm text-slate-600 mb-2">
                      {imagePreview ? "Clique para alterar" : "Clique para fazer upload"}
                    </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  checked={formData.equipment_replaced}
